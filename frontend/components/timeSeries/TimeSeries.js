    ...
    return (
        <>
            ...
            <p>
                ...
                define how each column <code>j</code> transforms the value in the column.
            </p>
            <p>
                We process these values by making <code>m</code> sounds.
                <code> f(i,j)</code> represents a value at <code>(i,j)</code> in the csv.
                We transform the value with
                <code>F(i,j) = (f(i,j) + offset_j) * multiplier_j + base_frequency_j</code>.
                Each <code>F(i,j)</code> is made with the envelope defined for column
                <code>j</code>.
            </p>
            {
                instrumentSamples ? <>
