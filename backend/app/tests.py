...
class FiltersTestCase(TestCase):
    ...
    def test_add_chords(self):
        audio_samples_1, sample_rate_1 = text_to_sound('This is marvelous day to get some sleep. The start of the new '
                                                       'semester brings a dark cloud. It is August.') 
        self.assertEqual(sample_rate_1, 44100)
        ...
        audio_samples_2, sample_rate_2 = text_to_sound('I fell and scraped my knee. It hurt a lot. I cried on the way '
    ...
    def test_change_volume(self):
        audio_samples_1, sample_rate_1 = text_to_sound('This is a great day for watching television. The climate '
        ...
        audio_samples_2, sample_rate_2 = text_to_sound('I like eating cake. I tried baking cake, but it tasted really '
    ...
    def test_change_pitch(self):
        audio_samples_1, sample_rate_1 = text_to_sound('This is a good day for some boating and doing barbeque. The '
        ...
        audio_samples_2, sample_rate_2 = text_to_sound('On my way home from school, I ran into a wall. I broke my '
